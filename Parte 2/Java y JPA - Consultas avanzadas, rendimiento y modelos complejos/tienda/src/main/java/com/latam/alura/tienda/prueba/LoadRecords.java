...
public class LoadRecords {
	...
	private static List<String> readFile(String type) throws FileNotFoundException {
		File file = new File("C:\\Users\\rodri\\OneDrive\\Documentos\\Backend_ONE_G4\\Parte 2\\Java y JPA - Consultas avanzadas, rendimiento y modelos complejos\\tienda\\src\\main\\resources\\utils\\"+type+".txt");
